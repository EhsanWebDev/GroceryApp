...
export function catagoriesList() {
  const request = axios
    .get(`${URL}api/CategoriesApi/ListCategories`)
...
export function subcategoriesList(id) {
  const request = axios
    .get(`${URL}api/ProductsApi/ShowSubcategories/?id=` + id)
    .then(res => res.data)
    .catch(e => console.log(e));
...
export function productsList(id) {
  const request = axios
    .get(`${URL}api/ProductsApi/ShowProduct/?id=` + id)
    .then(res => res.data)
    .catch(e => console.log(e));
...
export function allProductsList() {
  const request = axios
    .get(`${URL}api/OrdersApi/ProductsBuyUsers`)
    .then(res => res.data)
    .catch(e => console.log(e));
...
export function allAddress(id) {
  const req = axios
    .get(`${URL}api/OrdersApi/AllAddresses?id=` + id)
    .then(res => res.data)
    .catch(e => console.log(e));
...
export function getOrders(id) {
  const req = axios
    .get(`${URL}api/OrdersApi/AllOrderInformation?id=` + id)
    .then(res => res.data)
    .catch(e => {
      console.log(e);
    });
...
export function deleteOrder(id) {
  axios
    .get(`${URL}api/OrdersApi/DeleteOrder?id=` + id)
...
export function autoSignIn(id) {
  const req = axios
    .get(`${URL}api/UsersApi/FindUser/?id=` + id)
    .then(response => response.data)
    .catch(e => console.log(e));
...
export function allReviews(data) {
  return {
    type: "ALL_REVIEWS",
    payload: data
  };
