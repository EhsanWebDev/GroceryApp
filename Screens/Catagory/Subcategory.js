...
class Subcategory extends Component {
  ...
  componentDidMount(){
    this.props.dispatch(actions.subcategoriesList(this.props.navigation.getParam('catID')));
  }
  ...
  renderSubcategories(){
    ...
    <CatagoriesCard key={item.ID} navigation={this.props.navigation}
                name={item.NAME}
      ...
      <ScrollView style={{flex:1}}>
        <View style={styles.statusBar} />
            <View style = {styles.mainView}>
               {this.props.subcategories? this.renderSubcategories():
